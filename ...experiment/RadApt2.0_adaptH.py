...
triallist = []
for patch_number in range(10):
    for location in ['left', 'right', 'up', 'down']:
        for orientation in ['oriH', 'oriV']:
            tmp_dict = {'adapter':'adapterH','eccentricity':'15dva',
                        'VF':location, 'ori':orientation, 'patch':patch_number}
