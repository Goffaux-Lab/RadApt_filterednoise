...
cmd = os.chdir(r'C:\Users\arouxsibilon\OneDrive - UCL\Rprojects\2022_RadApt_filterednoise\...experiment\THFL3004')


print("Current working directory: {0}".format(os.getcwd()))
cwd = format(os.getcwd())

stimdir = cwd + '\stim_gabor\\' #directory where the stimuli are
...
gaborSizeDVA = 6
gaborSize15 = 200 # Size in pixels (15° ecc condition)
gaborSFDVA = 4
